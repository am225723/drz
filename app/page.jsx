...
const emphasisCards = [
  {
    ...
    icon: MessageCircle,
    imageUrl: 'https://images.pexels.com/photos/5699456/pexels-photo-5699456.jpeg?auto=compress&cs=tinysrgb&w=1600',
    text: 'A reflective space to understand patterns, emotions, relationships, history, and the meaning beneath symptoms.',
    accent: 'from-[#edf8f1] to-white border-[#9fcf9a]',
    highlights: ['Insight-oriented therapy', 'Integrated psychiatric care']
  },
  {
    title: 'Medication Management',
    label: 'Thoughtful prescribing',
    href: '/services/medication-management',
    icon: Pill,
    imageUrl: 'https://images.pexels.com/photos/3683098/pexels-photo-3683098.jpeg?auto=compress&cs=tinysrgb&w=1600',
    ...
    accent: 'from-[#f3f8f8] to-white border-[#2f8c85]',
    highlights: ['Medication review', 'Ongoing monitoring']
  }
];
