...
const emphasisCards = [
  { title: 'Psychotherapy', label: 'Reflective care', href: '/services/psychotherapy', icon: MessageCircle, image: STOCK_IMAGES.journalDesk, text: 'A reflective space to understand patterns, emotions, relationships, history, and the meaning beneath symptoms.', accent: 'from-[#edf8f1] to-white border-[#9fcf9a]', highlights: ['Insight-oriented therapy', 'Integrated psychiatric care'] },
  { title: 'Medication Management', label: 'Thoughtful prescribing', href: '/services/medication-management', icon: Pill, image: STOCK_IMAGES.consultationRoom, text: 'Thoughtful prescribing, medication review, monitoring, and collaborative decision-making within a whole-person care plan.', accent: 'from-[#f3f8f8] to-white border-[#2f8c85]', highlights: ['Medication review', 'Ongoing monitoring'] }
];
